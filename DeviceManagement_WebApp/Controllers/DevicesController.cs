...
namespace DeviceManagement_WebApp.Controllers
{
    public class DevicesController : Controller
    {
        ...
        public DevicesRepository devicesRepository = new DevicesRepository();
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await connectedOfficeContext);
        }
        ...
        public async Task<IActionResult> Details(Guid? id)
        {
            ...
            var device = await devicesRepository.GetById(id);
            if (device == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(Guid? id)
        {
            ...
            var device = await devicesRepository.Edit(id);
            if (device == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Delete(Guid? id)
        {
            ...
            var device = await devicesRepository.Delete(id);
            if (device == null)
            {
                return NotFound();
            }
        ...
        {
            var device = await devicesRepository.DeleteConfirmed(id);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
